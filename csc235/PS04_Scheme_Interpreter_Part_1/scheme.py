...
class Frame(object):
    ...
    def lookup(self, symbol):
        ...
        elif symbol not in self.bindings.keys() and self.parent is not None:
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target): 
        ...
        # BEGIN PROBLEM 5
        a = scheme_eval(expressions.rest.first, env)
        env.define(target, a)
        return target
        # END PROBLEM 5
